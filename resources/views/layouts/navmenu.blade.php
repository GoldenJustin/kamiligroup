  ...
  <nav class="fl-mega-menu nav-menu">
    <ul id="menu-main-menu" class="menu">
      <li id="menu-item-18768" class="nav-item menu-item-depth-0 current-menu-item "><a href="{{ url('home') }}"
          class="menu-link main-menu-link item-title"><i class="disable"></i>Home</a>

      </li>
      <li id="menu-item-7" class="nav-item menu-item-depth-0  "><a href="{{ url('about') }}"
      ...
      <li id="menu-item-18489" class="nav-item menu-item-depth-0 "><a href="{{ url('clients') }}"
      ...
      <li id="menu-item-18490" class="nav-item menu-item-depth-0 "><a
          href="{{ url('values') }}" class="menu-link main-menu-link item-title"><i
            class="disable"></i>core values</a></li>
      <li id="menu-item-18489" class="nav-item menu-item-depth-0 "><a href="{{ url('team') }}"
          class="menu-link main-menu-link item-title"><i class="disable"></i>Our Team</a>

      </li>
      <li id="menu-item-18489" class="nav-item menu-item-depth-0 "><a href="{{ url('contact') }}"
