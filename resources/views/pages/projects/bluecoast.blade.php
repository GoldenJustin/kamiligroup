              ...
              <div class="post-gallery-slider">
                ...
                <div class="gallery-img">
                  <img width="945" height="558"
                    src="{{ asset('assets/Photos/BlueCoast-Offices/bluecoast-image-2.jpeg')}}"
                    class="attachment-revus_size_1170x658_crop size-revus_size_1170x658_crop" alt="" decoding="async"
                    loading="lazy" />
                </div>
                <div class="gallery-img">
                  <img width="945" height="558"
                    src="{{ asset('assets/Photos/BlueCoast-Offices/bluecoast-image-3.jpeg')}}"
                    class="attachment-revus_size_1170x658_crop size-revus_size_1170x658_crop" alt="" decoding="async"
                    loading="lazy" />
                </div>
                <div class="gallery-img">
                ...
                <div class="gallery-img">
                  <img width="945" height="558"
                    src="{{ asset('assets/Photos/BlueCoast-Offices/bluecoast-image-4.jpeg')}}"
                    class="attachment-revus_size_1170x658_crop size-revus_size_1170x658_crop" alt="" decoding="async"
                    loading="lazy" />
                </div>
                <div class="gallery-img">
                  <img width="945" height="558"
                    src="{{ asset('assets/Photos/BlueCoast-Offices/bluecoast-image-5.jpeg')}}"
                    class="attachment-revus_size_1170x658_crop size-revus_size_1170x658_crop" alt="" decoding="async"
                    loading="lazy" />
                </div>
                <div class="gallery-img">
                  <img width="945" height="558"
                    src="{{ asset('assets/Photos/BlueCoast-Offices/bluecoast-image-6.jpeg')}}"
                    class="attachment-revus_size_1170x658_crop size-revus_size_1170x658_crop" alt="" decoding="async"
                    loading="lazy" />
                </div>
              </div>
          ...
          <div class="post-bottom-content">
            <h5 class="post--title">
              <a class="title-link fl-secondary-color fl-primary-hv-color">
                Proposed Office design and partitions for Blue Cost Investment Ltd </a>
            </h5>
