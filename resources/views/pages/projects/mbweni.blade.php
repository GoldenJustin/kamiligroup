              ...
              <div class="post-gallery-slider">
                ...
                <div class="gallery-img">
                  <img width="945" height="558"
                    src="{{ asset('assets/Photos/Mbweni/Mbweni-1.png')}}"
                    class="attachment-revus_size_1170x658_crop size-revus_size_1170x658_crop" alt="" decoding="async"
                    loading="lazy" />
                </div>
                <div class="gallery-img">
                  <img width="945" height="558"
                    src="{{ asset('assets/Photos/Mbweni/Mbweni-2.png')}}"
                    class="attachment-revus_size_1170x658_crop size-revus_size_1170x658_crop" alt="" decoding="async"
                    loading="lazy" />
                </div>
                <div class="gallery-img">
                  <img width="945" height="558"
                    src="{{ asset('assets/Photos/Mbweni/Mbweni-3.png')}}"
                    class="attachment-revus_size_1170x658_crop size-revus_size_1170x658_crop" alt="" decoding="async"
                    loading="lazy" />
                </div>
          ...
          <div class="post-bottom-content">
            <h5 class="post--title">
              <a class="title-link fl-secondary-color fl-primary-hv-color">
                Proposed Construction of Residential House in Mbeni DSM </a>
            </h5>

            <div class="post-text--content fl-font-style-regular">
              <p>Project Year: 2021</p>
