...
@section('content')
<div class="fl-page-heading " style=background-image:url(assets/images/uploads/2019/06/page-heading-image.jpg);margin-bottom:25px;>
  <div class="container">
    <div class="row">
        ...
        <div class="header-entry-container">
          ...
          <div class="breadcrumbs-heading">
            ...
            <div class="breadcrumbs"><span><a rel="v:url" property="v:title"
                  href="{{url ('/')}}">Home</a></span><span class="breadcrumbs-delimiter"><i
